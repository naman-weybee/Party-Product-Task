...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table align="center">
        ...
        <tr>
            <td>&nbsp;</td>
            <td>
                <asp:Button ID="btnAddToInvoice" runat="server" Text="Add To Invoice" OnClick="btnAddToInvoice_Click" ValidationGroup="submit" CssClass="AddInvoice" />
            </td>
        </tr>
    </table>
    <br />
    ...
    <div class="TableContent">
        <asp:GridView ID="gdInvoice" runat="server" AutoGenerateColumns="False" DataKeyNames="id" Width="100%" CellPadding="4" GridLines="None" ForeColor="#333333">
            ...
            <HeaderStyle HorizontalAlign="Left" BackColor="#0099CC" Font-Bold="True" ForeColor="Black" />
    ...
    <br />
    <div class="closeinvoiceDiv">
        <asp:Button ID="btnClearInvoice" runat="server" OnClick="btnClearInvoice_Click" Text="Clear Invoice" CssClass="ClearInvoice" />
        <asp:Button ID="btnCloseInvoice" runat="server" Text="Close Invoice" OnClick="btnCloseInvoice_Click" CssClass="CloseInvoice" />
    </div>
</asp:Content>
